...
public enum DecodingGroup {
    ...
    RIM_WIDE_SO_EI8         (false, false, true, true, true, true, false),
    RIM_WIDE_R32S_WOD       (true, true, true, true, true, false, false),
    RIM_DO_WOD_EI8          (true, false, false, false, true, true, false),
    RIM_R32D                (true, true, true, false, true, false, false),
    RIM_WIDE_DO_WOD_EI8     (true, true, false, false, true, true, false),
