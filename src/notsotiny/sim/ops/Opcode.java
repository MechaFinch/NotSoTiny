...
public enum Opcode {    
    ...
    MOV_RIM     (0x20, Operation.MOV),
    XCHG_RIM    (0x21, Operation.XCHG),
    
    XCHG_AH_AL  (0x22, Operation.XCHG),
    XCHG_BH_BL  (0x23, Operation.XCHG),
    XCHG_CH_CL  (0x24, Operation.XCHG),
    XCHG_DH_DL  (0x25, Operation.XCHG),
    
    MOV_A_B     (0x26, Operation.MOV),
    MOV_A_C     (0x27, Operation.MOV),
    MOV_A_D     (0x28, Operation.MOV),
    MOV_B_A     (0x29, Operation.MOV),
    MOV_B_C     (0x2A, Operation.MOV),
    MOV_B_D     (0x2B, Operation.MOV),
    MOV_C_A     (0x2C, Operation.MOV),
    MOV_C_B     (0x2D, Operation.MOV),
    MOV_C_D     (0x2E, Operation.MOV),
    MOV_D_A     (0x2F, Operation.MOV),
    MOV_D_B     (0x30, Operation.MOV),
    MOV_D_C     (0x31, Operation.MOV),

    MOV_AL_BL   (0x32, Operation.MOV),
    MOV_AL_CL   (0x33, Operation.MOV),
    MOV_AL_DL   (0x34, Operation.MOV),
    MOV_BL_AL   (0x35, Operation.MOV),
    MOV_BL_CL   (0x36, Operation.MOV),
    MOV_BL_DL   (0x37, Operation.MOV),
    MOV_CL_AL   (0x38, Operation.MOV),
    MOV_CL_BL   (0x39, Operation.MOV),
    MOV_CL_DL   (0x3A, Operation.MOV),
    MOV_DL_AL   (0x3B, Operation.MOV),
    MOV_DL_BL   (0x3C, Operation.MOV),
    MOV_DL_CL   (0x3D, Operation.MOV),
    
    XCHG_A_B    (0x3E, Operation.XCHG),
    XCHG_A_C    (0x3F, Operation.XCHG),
    XCHG_A_D    (0x40, Operation.XCHG),
    XCHG_B_C    (0x41, Operation.XCHG),
    XCHG_B_D    (0x42, Operation.XCHG),
    XCHG_C_D    (0x43, Operation.XCHG),
    
    XCHG_AL_BL  (0x44, Operation.XCHG),
    XCHG_AL_CL  (0x45, Operation.XCHG),
    XCHG_AL_DL  (0x46, Operation.XCHG),
    XCHG_BL_CL  (0x47, Operation.XCHG),
    XCHG_BL_DL  (0x48, Operation.XCHG),
    XCHG_CL_DL  (0x49, Operation.XCHG),
    
    PUSH_A      (0x4A, Operation.PUSH),
    PUSH_B      (0x4B, Operation.PUSH),
    PUSH_C      (0x4C, Operation.PUSH),
    PUSH_D      (0x4D, Operation.PUSH),
    PUSH_I      (0x4E, Operation.PUSH),
    PUSH_J      (0x4F, Operation.PUSH),
    PUSH_BP     (0x50, Operation.PUSH),
    PUSH_SP     (0x51, Operation.PUSH),
    PUSH_F      (0x52, Operation.PUSH),
    PUSH_RIM    (0x53, Operation.PUSH),
    ...
    POP_BP      (0x5A, Operation.POP),
    POP_SP      (0x5B, Operation.POP),
    POP_F       (0x5C, Operation.POP),
    POP_RIM     (0x5D, Operation.POP),
    
    AND_F_RIM   (0x5E, Operation.AND),
    AND_RIM_F   (0x5F, Operation.AND),
    OR_F_RIM    (0x60, Operation.OR),
    OR_RIM_F    (0x61, Operation.OR),
    XOR_F_RIM   (0x62, Operation.XOR),
    XOR_RIM_F   (0x63, Operation.XOR),
    NOT_F       (0x64, Operation.NOT),
    
    MOV_F_RIM   (0x66, Operation.MOV),
    MOV_RIM_F   (0x67, Operation.MOV),
    
    INC_I       (0x68, Operation.INC),
    INC_J       (0x69, Operation.INC),
    ICC_I       (0x6A, Operation.ICC),
    ICC_J       (0x6B, Operation.ICC),
    DEC_I       (0x6C, Operation.DEC),
    DEC_J       (0x6D, Operation.DEC),
    DCC_I       (0x6E, Operation.DCC),
    DCC_J       (0x6F, Operation.DCC),
    ...
    INC_RIM     (0x98, Operation.INC),
    ICC_RIM     (0x99, Operation.ICC),
    PINC_RIMP   (0x9A, Operation.PINC),
    PICC_RIMP   (0x9B, Operation.PICC),
    
    DEC_RIM     (0x9C, Operation.DEC),
    DCC_RIM     (0x9D, Operation.DCC),
    PDEC_RIMP   (0x9E, Operation.PDCC),
    PDCC_RIMP   (0x9F, Operation.PDCC),
