...
public enum Opcode {    
    ...
    ICC_A       (0x7C, Operation.ICC),
    ICC_B       (0x7D, Operation.ICC),
    ICC_C       (0x7E, Operation.ICC),
    ICC_D       (0x7F, Operation.ICC),
    ...
    DCC_A       (0x8C, Operation.DCC),
    DCC_B       (0x8D, Operation.DCC),
    DCC_C       (0x8E, Operation.DCC),
    DCC_D       (0x8F, Operation.DCC),
